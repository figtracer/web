...
the main tx-pool `maintainer.rs` function `maintain_transaction_pool` is located here [maintain.rs#L123](https://github.com/paradigmxyz/reth/blob/main/crates/transaction-pool/src/maintain.rs#L123)
